...
--
-- Host: db:3306
-- Generation Time: Jun 30, 2024 at 03:06 AM
...
CREATE TABLE `campaigns` (
  ...
  `campaign_description` text COLLATE utf8mb4_general_ci,
...
(5, 38, 31, 15.00, '2024-06-28', '2024-07-20');
...
CREATE TABLE `sellers` (
  `id` int NOT NULL,
  `seller_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `support_tickets` (
  ...
  `message` text COLLATE utf8mb4_general_ci NOT NULL,
  `status` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'open'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `support_tickets` (`id`, `seller_id`, `subject`, `message`, `status`) VALUES
(1, 38, 'Help With Dashboard', 'pls help witht his', 'open');
...
CREATE TABLE `users` (
  ...
  `user_type` enum('user','admin','seller') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'user',
  `image` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(34, 'Admin', 'admin@gmail.com', '202cb962ac59075b964b07152d234b70', 'admin', 'Nahidh_Naseem.jpg'),
(35, 'John Doe', 'johndoe@gmail.com', '202cb962ac59075b964b07152d234b70', 'user', 'Screenshot 2024-03-30 171252.jpg'),
(36, 'Nahidh Naseem', 'mnmnahidh@gmail.com', 'c2d22dc53248f85946080063017b15aa', 'admin', '1697210757013.jpeg'),
(37, 'Nazmil Naseem', 'mnmnazmil96@gmail.com', '9ed45d775ea9be8037c86b5b21c74bdf', 'seller', 'Nahidh_Naseem.jpg'),
(38, 'bandara', 'bandara@gmail.com', '202cb962ac59075b964b07152d234b70', 'seller', 'logowhatspp.png'),
(39, 'nimal', 'nimal@gmail.com', '202cb962ac59075b964b07152d234b70', 'user', 'N.png');
